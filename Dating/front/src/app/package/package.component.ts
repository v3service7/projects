...
export class PackagelistComponent implements OnInit {
  ...
  constructor(private packageService: PackageService,private router: Router,private alertService: AlertService) { }
...
export class PackageupdateComponent implements OnInit {
  ...
  constructor(private lf: FormBuilder, private alertService: AlertService,private packageService: PackageService,private router: Router,private activatedRoute: ActivatedRoute) { }
