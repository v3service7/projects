...
var SpeedDatingPage = (function () {
    function SpeedDatingPage(navCtrl, diagnostic, navParams, nav, customerService, bannerService, socketService) {
    ...
    SpeedDatingPage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    SpeedDatingPage.prototype.ionViewWillUnload = function () {
        this.endCall();
    };
    SpeedDatingPage.prototype.ngOnDestroy = function () {
        this.endCall();
        this.setNewTokboxToken();
    };
    SpeedDatingPage.prototype.setNewTokboxToken = function () {
        this.customerService.changeTokboxToken(this.cid).subscribe(function (item) {
        });
    };
    SpeedDatingPage.prototype.getCustomer = function () {
        var _this = this;
    ...
    // Starts Call
    SpeedDatingPage.prototype.initializeSession = function () {
        var _this = this;
    ...
    SpeedDatingPage.prototype.deductPackageCalls = function () {
    ...
    // Ends call
    SpeedDatingPage.prototype.endCall = function () {
        if (!!this.session) {
    ...
    // Banner section
    SpeedDatingPage.prototype.loadAllTime = function () {
        var _this = this;
    ...
    SpeedDatingPage.prototype.loadAllTimeImage = function () {
        var _this = this;
    ...
    SpeedDatingPage.prototype.loadbanners = function (type) {
        var _this = this;
        var obj = { type: type };
    ...
    SpeedDatingPage.prototype.opencallImage = function () {
    ...
    SpeedDatingPage.prototype.setitem = function (temp) {
        console.log("setItem");
        var random = temp;
    ...
    SpeedDatingPage.prototype.setitemImage = function (temp) {
        var random = temp;
    ...
    SpeedDatingPage.prototype.repeatset = function (random) {
        var _this = this;
    ...
    SpeedDatingPage.prototype.repeatsetImage = function (random) {
        var _this = this;
    ...
    SpeedDatingPage.prototype.randno = function () {
        var random = Math.floor(Math.random() * this.banner.length);
        console.log("randno" + random);
        return random;
    };
    SpeedDatingPage.prototype.randnoImage = function () {
        var random = Math.floor(Math.random() * this.bannerImage.length);
        console.log("randno" + random);
        return random;
    };
    SpeedDatingPage.prototype.sendMessageOnCall = function () {
        //alert("msg send");
    ...
    SpeedDatingPage.prototype.close = function () {
        // Get the modal
        document.getElementById('myModalbanner').style.display = 'none';
    };
    SpeedDatingPage.prototype.closeImage = function () {
        // Get the modal
        document.getElementById('mybannerimage').style.display = 'none';
    };
    SpeedDatingPage.prototype.modelOpen = function (random) {
        this.bannervideo = '';
        var modal = document.getElementById('myModal');
        modal.style.display = "block";
        this.bannervideo = this.banner[random];
    };
    SpeedDatingPage.prototype.modelClose = function () {
        var modal = document.getElementById('myModal');
        modal.style.display = "none";
    };
    SpeedDatingPage.prototype.vi = function () {
        var _this = this;
        setTimeout(function () {
    ...
    SpeedDatingPage.prototype.closeviImage = function () {
        var _this = this;
        setTimeout(function () {
...
export { SpeedDatingPage };
//# sourceMappingURL=speeddating.js.map