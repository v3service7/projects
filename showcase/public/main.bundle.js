...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs_add_observable_interval__ = __webpack_require__("../../../../rxjs/add/observable/interval.js");
...
var CustomerListComponent = (function () {
    ...
    CustomerListComponent.prototype.paidStatusChange = function (user_id, value) {
        var _this = this;
        var obj = {
            _id: user_id,
            ispaid: value
        };
        this.customerService.userUpdate(obj).subscribe(function (data) {
            if (!data.error) {
                _this._flashMessagesService.show('Paid status change successfully.', { cssClass: 'alert-success', timeout: 3000 });
            }
        });
    };
...
var AdminUserBoardsBookmarkComponent = (function () {
    ...
    AdminUserBoardsBookmarkComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_7_rxjs_Observable__["Observable"].interval(1000).subscribe(function (x) {
            _this.manageUI();
        });
    ...
    AdminUserBoardsBookmarkComponent.prototype.manageUI = function () {
        var cols = 4;
        if ($('body').width() > 1600) {
            cols = 4;
        }
    ...
    AdminUserBoardsBookmarkComponent.prototype.convertToGridItem = function (htmlInc, id) {
    ...
    AdminUserBoardsBookmarkComponent.prototype.getBookmarks = function () {
        ...
        this.adminService.bookmarkList(this.board_id).subscribe(function (data) {
            if (!data.error) {
                ...
                console.log(_this.bookmarks.length);
                if (_this.bookmarks.length > 0) {
                    for (var i = 0; i < _this.bookmarks.length; i++) {
                        // tslint:disable-next-line:max-line-length
                        document.getElementById('showcaseSocialBlock').innerHTML += _this.convertToGridItem(_this.bookmarks[i]['body'], _this.bookmarks[i]['_id']);
                    }
                    setTimeout(function () {
    ...
    AdminUserBoardsBookmarkComponent.prototype.jio = function () {
        var _this = this;
        $(document).on('click', 'div.jio-class', function (data, err) {
            _this.deletebookmark(data.target.offsetParent.id);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43_ng2_sharebuttons__ = __webpack_require__("../../../../ng2-sharebuttons/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__public_public_component__ = __webpack_require__("../../../../../src/app/public/public.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45_ngx_clipboard__ = __webpack_require__("../../../../ngx-clipboard/dist/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46_ngx_ui_switch__ = __webpack_require__("../../../../ngx-ui-switch/ui-switch.es5.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__safe_html_pipe__ = __webpack_require__("../../../../../src/app/safe-html.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49_ngx_loading__ = __webpack_require__("../../../../ngx-loading/ngx-loading/ngx-loading.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_26__frontend_dashboard_frontenddashboard_component__["a" /* FrontendDashboardComponent */], __WEBPACK_IMPORTED_MODULE_26__frontend_dashboard_frontenddashboard_component__["b" /* MyProfileComponent */], __WEBPACK_IMPORTED_MODULE_26__frontend_dashboard_frontenddashboard_component__["f" /* ViewPublicComponent */],
            ...
            __WEBPACK_IMPORTED_MODULE_44__public_public_component__["a" /* PublicComponent */],
            __WEBPACK_IMPORTED_MODULE_48__safe_html_pipe__["a" /* SafeHtmlPipe */]
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_49_ngx_loading__["b" /* LoadingModule */].forRoot({
                animationType: __WEBPACK_IMPORTED_MODULE_49_ngx_loading__["a" /* ANIMATION_TYPES */].rectangleBounce,
            ...
            __WEBPACK_IMPORTED_MODULE_47_ngx_infinite_scroll__["a" /* InfiniteScrollModule */],
            __WEBPACK_IMPORTED_MODULE_46_ngx_ui_switch__["a" /* UiSwitchModule */],
            __WEBPACK_IMPORTED_MODULE_45_ngx_clipboard__["a" /* ClipboardModule */],
...
var ProfileHeaderComponent = (function () {
    ...
    function ProfileHeaderComponent(route, toastr, validateService, vRef, userService, categoryService, bookService, router, lf) {
        ...
        this.router = router;
        this.lf = lf;
        this.bookmarkposition = 'top';
        this.isCopied1 = false;
        this.invalidUrl = false;
        this.isHere = false;
        this.showcaseField = false;
        this.categorySelectedId = false;
        this.sendIdEvent = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
    ...
    ProfileHeaderComponent.prototype.bookmarkPosition = function (position) {
    ...
    ProfileHeaderComponent.prototype.addBoodmark = function (id) {
        ...
        this.bookService.bookmarkAdd(this.addLinkForm.value).subscribe(function (data) {
            if (!data.eror) {
                ...
                _this.sendIdEvent.emit(_this.addLinkForm.value);
                setTimeout(function () {
        ...
        if (this.customer) {
            if (!this.isHere) {
                this.userService.getProfile().subscribe(function (data) {
                    if (data.user) {
                        _this.isHere = true;
                        _this.currentCustomerImage = data.user.image;
...
], ProfileHeaderComponent.prototype, "sendIdEvent", void 0);
...
var MyProfileComponent = (function () {
    ...
    MyProfileComponent.prototype.upload = function () {
        ...
        this.makeFileRequest('https://measuremight.com:3002/upload', [], this.filesToUpload).then(function (result) {
            _this.customerProfileForm.controls['image'].setValue(__WEBPACK_IMPORTED_MODULE_14__global__["a" /* url */] + '/uploads/' + result['filename']);
            _this.profileUpdate();
            _this.modelClose();
        }, function (error) {
            console.error(error);
    ...
    MyProfileComponent.prototype.getProfile = function () {
        ...
        this.userService.getProfile().subscribe(function (data) {
            if (data.user) {
                ...
                _this.croppedImage = data.user.image;
        ...
        this.userService.checkPassword(obj).subscribe(function (data) {
            if (!data.error) {
                if (_this.customerPasswordUpdateForm.value['newpassword'] === _this.customerPasswordUpdateForm.value['confirmpassword']) {
                    var obj = {};
                    obj['_id'] = _this.customer['_id'];
                    obj['password'] = _this.customerPasswordUpdateForm.value['newpassword'];
                    // tslint:disable-next-line:no-shadowed-variable
                    _this.userService.resetPassword(obj).subscribe(function (data) {
                        if (!data.error) {
    ...
    MyProfileComponent.prototype.onChange = function (event) {
        ...
        this.uploader.onCompleteItem = function (item, response, status, headers) {
            ...
            _this.customerProfileForm.controls['image'].setValue(__WEBPACK_IMPORTED_MODULE_14__global__["a" /* url */] + '/uploads/' + responsePath.filename);
            _this.profileUpdate();
        };
    };
...
var SettingComponent = (function () {
    ...
    SettingComponent.prototype.getProfile = function () {
        var _this = this;
        this.userService.getProfile().subscribe(function (data) {
            if (data.user) {
    ...
    SettingComponent.prototype.onScroll = function () {
    ...
    SettingComponent.prototype.getbookmark = function (id, obj) {
        var _this = this;
        this.bookmarkService.categoryBookmarks(id, obj).subscribe(function (data) {
            if (!data.error) {
                console.log(data.message.length);
                for (var index = 0; index < data.message.length; index++) {
                    _this.bookmarks.push(data.message[index]);
                }
                setTimeout(function () {
                    instgrm.Embeds.process();
                    twttr.widgets.load();
...
var ViewPublicComponent = (function () {
    function ViewPublicComponent(router, route, bookmarkService, categoryService, sanitizer) {
        ...
        this.gridColWidth = '';
        this.loader = false;
        ViewComponent.updateBookmarkStatus.subscribe(function (res) {
            _this.route.params.subscribe(function (params) {
                var id = params['id'];
    ...
    ViewPublicComponent.prototype.printMsg = function (msg) {
        var el1 = this.convertToGridItem(msg['body']);
        var el = $(el1);
    ...
    ViewPublicComponent.prototype.onScroll = function () {
        var _this = this;
        this.loader = true;
        this.scrollCount = 20 * this.pageNumber;
        var obj = {
        ...
        this.bookmarkService.categoryBookmarksPublic(this.parentMessage, obj).subscribe(function (data) {
            if (!data.error) {
                if (data.message.length > 0) {
                    var htmlBlocks = '';
                    var tot = data.message.length - 1;
                    for (var i = 0; i < data.message.length; i++) {
                        _this.bookmarks.push(data.message[i]);
                        htmlBlocks = _this.convertToGridItem(data.message[i]['body']);
                        var el = $(htmlBlocks);
    ...
    ViewPublicComponent.prototype.ngOnDestroy = function () {
        this.obTime.unsubscribe();
    };
    ViewPublicComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.obTime = __WEBPACK_IMPORTED_MODULE_12_rxjs_Observable__["Observable"].interval(1000).subscribe(function (x) {
            _this.manageUI();
        });
    };
    ...
    ViewPublicComponent.prototype.getbookmark = function (id, obj) {
        var _this = this;
        if (typeof obj === 'undefined') {
            document.getElementById('showcaseSocialBlock').innerHTML = '';
        }
        this.bookmarkService.categoryBookmarksPublic(id, obj).subscribe(function (data) {
            if (!data.error) {
                if (data.message.length > 0) {
                    var htmlBlocks = "";
                    for (var i = 0; i < data.message.length; i++) {
                        _this.bookmarks.push(data.message[i]);
                        htmlBlocks += _this.convertToGridItem(_this.bookmarks[i]['body']);
                        // tslint:disable-next-line:max-line-length
...
ViewPublicComponent.updateBookmarkStatus = new __WEBPACK_IMPORTED_MODULE_11_rxjs_Subject__["Subject"]();
...
var ViewComponent = ViewComponent_1 = (function () {
    ...
    ViewComponent.prototype.printMsg = function (msg) {
        var el1 = this.convertToGridItem(msg['body']);
        var el = $(el1);
        $("#showcaseSocialBlock").prepend(el).masonry('prepended', el);
        instgrm.Embeds.process();
    ...
    ViewComponent.prototype.onScroll = function () {
        var _this = this;
        this.loader = true;
        this.scrollCount = 20 * this.pageNumber;
        var obj = {
        ...
        this.bookmarkService.categoryBookmarks(this.parentMessage, obj).subscribe(function (data) {
            if (!data.error) {
                if (data.message.length > 0) {
                    var htmlBlocks = '';
                    var tot = data.message.length - 1;
    ...
    ViewComponent.prototype.getbookmark = function (id, obj) {
        var _this = this;
        if (typeof obj === 'undefined') {
            document.getElementById('showcaseSocialBlock').innerHTML = '';
        }
...
var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, ViewComponent_1, _2, _3, _4, _5, _6;
...
module.exports = "<app-profileheader  (sendIdEvent)=\"printMsg($event)\"></app-profileheader>\r\n<div style=\"padding-top: 65px;\">\r\n\t<h1 *ngIf=\"bookmarks?.length <= 0\" class=\"text-center text-muted pt-5\">No bookmarks available.</h1>\r\n\r\n\t<div  [ngClass]=\"(bookmarks?.length)?'search-results':''\" infiniteScroll [infiniteScrollDistance]=\"2\" [infiniteScrollThrottle]=\"50\" (scrolled)=\"onScroll()\"\r\n\t [scrollWindow]=\"false\">\r\n\t<div id=\"showcaseSocialBlock\" class=\"grid\" style=\"padding-left:10px;\"></div>\r\n\t<img src=\"https://measuremight.com:3002/assets/loader.svg\" alt=\"loading\" id=\"viewloader\" *ngIf=\"loader\" style=\"bottom: 0;\r\n position: absolute; left: 0px; right: 0px; margin: auto;\">\r\n\t</div>\r\n\t<!-- <div *ngFor=\"let bookmark of bookmarks; let i = index; let last = last;\">\r\n\t\t<div *ngIf=\"bookmark.type == 'facebook'\" class=\"fb-post\" [attr.data-href]=\"bookmark.url\"></div>\t\r\n\t</div> -->\r\n</div>"
...
module.exports = "<app-profileheader (sendIdEvent)=\"printMsg($event)\"></app-profileheader>\r\n<div style=\"padding-top: 65px;\">\r\n    <h1 *ngIf=\"bookmarks?.length <= 0\" class=\"text-center text-muted pt-5\">No bookmarks available.</h1>\r\n\r\n    <div [ngClass]=\"(bookmarks?.length)?'search-results':''\" infiniteScroll [infiniteScrollDistance]=\"2\" [infiniteScrollThrottle]=\"50\"\r\n        (scrolled)=\"onScroll()\" [scrollWindow]=\"false\">\r\n        <div id=\"showcaseSocialBlock\" class=\"grid\" style=\"padding-left:10px;\"></div>\r\n        <img src=\"https://measuremight.com:3002/assets/loader.svg\" alt=\"loading\" id=\"viewloader\" *ngIf=\"loader\" style=\"bottom: 0;\r\n position: absolute; left: 0px; right: 0px; margin: auto;\">\r\n    </div>\r\n    <!-- <div *ngFor=\"let bookmark of bookmarks; let i = index; let last = last;\">\r\n\t\t<div *ngIf=\"bookmark.type == 'facebook'\" class=\"fb-post\" [attr.data-href]=\"bookmark.url\"></div>\t\r\n\t</div> -->\r\n</div>"
...
var FrontendHomeComponent = (function () {
    function FrontendHomeComponent(_auth, router, lf, userService, route, _flashMessagesService, zone) {
        this._auth = _auth;
        this.router = router;
        this.lf = lf;
        this.userService = userService;
                    ...
                    if (!loggedUser.success) {
                        _this.userService.socialRegisterUser(obj).subscribe(function (newUser) {
                            _this.userService.socialValidateUser(obj).subscribe(function (loggedUserOauth) {
                                ...
                                _this.userService.mycategory().subscribe(function (category) {
                                    if (!category.error) {
                                        _this.returnUrl = _this.route.snapshot.queryParams['returnUrl'] || 'view/' + category.message[0]._id;
                                    }
                    ...
                    _this.userService.socialRegisterUser(obj).subscribe(function (newUser) {
                        _this.userService.socialValidateUser(obj).subscribe(function (loggedUserOauth) {
                            ...
                            _this.userService.mycategory().subscribe(function (category) {
                                ...
                                _this.zone.run(function () { return _this.returnUrl; });
                            });
                        });
                    });
                }
...
ResetComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"]) === "function" && _h || Object, typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_4__services_user_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__services_user_service__["a" /* UserService */]) === "function" && _j || Object, typeof (_k = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _k || Object, typeof (_l = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _l || Object])
], ResetComponent);
...
AccountActiveComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_m = typeof __WEBPACK_IMPORTED_MODULE_4__services_user_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__services_user_service__["a" /* UserService */]) === "function" && _m || Object, typeof (_o = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _o || Object, typeof (_p = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _p || Object, typeof (_q = typeof __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormBuilder"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormBuilder"]) === "function" && _q || Object, typeof (_r = typeof __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"]) === "function" && _r || Object])
...
var AdminService = (function () {
    function AdminService(http) {
        this.http = http;
        // tslint:disable-next-line:max-line-length
        this.validateToken = 'showcase eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..mPlmkuFDISGyjUl6GzELjKTCrAfmdjtuSdtrF45yLvY';
    }
...
var BookmarkService = (function () {
    ...
    BookmarkService.prototype.categoryBookmarks = function (id, obj) {
        if (obj) {
    ...
    BookmarkService.prototype.categoryBookmarksPublic = function (id, obj) {
        if (obj) {
            id = id + '?start=' + obj.start + '&end=' + obj.end;
        }
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
