...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_20__admin_customer_customer_component__["a" /* AdminCustomerComponent */], __WEBPACK_IMPORTED_MODULE_20__admin_customer_customer_component__["d" /* CustomerListComponent */], __WEBPACK_IMPORTED_MODULE_20__admin_customer_customer_component__["b" /* CustomerAddComponent */], __WEBPACK_IMPORTED_MODULE_20__admin_customer_customer_component__["c" /* CustomerEditComponent */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__global__ = __webpack_require__("../../../../../src/app/global.ts");
...
var MyProfileComponent = (function () {
    function MyProfileComponent(lf, userService, _flashMessagesService) {
        ...
        this.userService = userService;
        this._flashMessagesService = _flashMessagesService;
        this.uploader = new __WEBPACK_IMPORTED_MODULE_4_ng2_file_upload__["FileUploader"]({ url: __WEBPACK_IMPORTED_MODULE_11__global__["a" /* url */] + 'upload' });
    ...
    SettingComponent.prototype.changePosition = function (type, bookmark_id, position) {
        ...
        this.bookmarkService.changePosition(obj).subscribe(function (data) {
            if (!data.error) {
                ...
                _this.toastr.error('Erro while chaning bookmakr position, Try again.', 'Oops!');
            }
        });
    };
...
var ViewComponent = (function () {
    ...
    ViewComponent.prototype.doStuff = function (event) {
        console.log(event);
    };
...
__decorate([
    ...
    __metadata("design:type", typeof (_x = typeof __WEBPACK_IMPORTED_MODULE_12_angular2_masonry__["a" /* AngularMasonry */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_12_angular2_masonry__["a" /* AngularMasonry */]) === "function" && _x || Object)
], ViewComponent.prototype, "masonry", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_12_angular2_masonry__["a" /* AngularMasonry */]),
    __metadata("design:type", typeof (_y = typeof __WEBPACK_IMPORTED_MODULE_12_angular2_masonry__["b" /* AngularMasonryBrick */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_12_angular2_masonry__["b" /* AngularMasonryBrick */]) === "function" && _y || Object)
...
module.exports = "<app-profileheader></app-profileheader>\r\n<div  *ngIf=\"curColWidth != 0\"  style=\"padding-top: 75px;\">\r\n\t<masonry [options]=\"options\" [useImagesLoaded]=\"true\">\r\n\t    <!-- <div class=\"row\"> -->\r\n\t\t\t<masonry-brick *ngFor=\"let bookmark of bookmarks\">\r\n\t\t\t\t<div class=\"grid-item\">\r\n\t\t\t\t\t<iframe [src]=\"videoUrl(bookmark.title)\" [height]=\"setHeight(bookmark.type)\"  [width]=\"setWidth(bookmark.type)\"  frameborder=\"0\" allowfullscreen></iframe>\r\n\t\t\t\t</div>\r\n\t\t\t</masonry-brick>\r\n\t\t<!-- </div> -->\r\n\t</masonry>\r\n</div>"
